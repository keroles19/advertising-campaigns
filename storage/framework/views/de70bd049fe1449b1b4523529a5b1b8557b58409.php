                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"><?php echo app('translator')->get('Edit Campaign'); ?></h4>
                        </div>
                        <div class="card-body">
                            <?php echo $__env->make('partials.errors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <form action="<?php echo e(route('campaign.update',$model->id)); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-md-6 col-sm-12 mb-2">
                                        ...
                                        <input type="date" name="from" class="form-control" value="<?php echo e(date_format($model->from,'Y-m-d')); ?>"/>
                                    </div>

                                    <div class="col-xl-6 col-md-6 col-sm-12 mb-2">
                                        <label class="form-label" ><?php echo app('translator')->get('to'); ?></label>
                                        <input type="date" name="to" class="form-control" value="<?php echo e(date_format($model->to,'Y-m-d')); ?>"/>
                                    </div>

                                    <div class="col-xl-6 col-md-6 col-sm-12 mb-2">
                                        <label class="form-label" ><?php echo app('translator')->get('total'); ?></label>
                                        <input type="text" name="total" class="form-control" value="<?php echo e($model->total); ?>"/>
                                    </div>
                                    <div class="col-xl-6 col-md-6 col-sm-12 mb-2">
                                        <label class="form-label" ><?php echo app('translator')->get('daily_budget'); ?></label>
                                        <input type="text" name="daily_budget" value="<?php echo e($model->daily_budget); ?>" class="form-control"/>
                                    </div>
...
<?php echo $__env->make('layouts.layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/kero/CS/Projects/Interviews Project/laravel-task/resources/views/campaigns/edit.blade.php ENDPATH**/ ?>